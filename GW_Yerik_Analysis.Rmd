...
ggplot(data = gjb, aes(x=age))+geom_bar(stat="count")+labs(x="Age",title="Age Distribution")
...
```{r Dating, echo = TRUE, out.width = "60%", fig.align = "center"}
...
- No gender difference found in online dating.
...
### Q3: What's the gender and age difference in gaming?
...
### Q4: The relationship between gaming and dating
